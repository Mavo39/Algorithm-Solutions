...
| 06-25 | デック | getMax | PHP | [Code](../Deque/problems/02_getMax/php/src/getMax.php)| 型指定の方法について学ぶ |
| 06-26 | デック | getMaxWindow | JavaScript | [Code](../Deque/problems/03_getMaxWindow/js/src/getMaxWindow.js)| JSON.stringfy()による内容の比較 |
| 06-27 | スタック | isParenthesesValid | PHP | [Code](../Stack/isParenthesesValid/php/src/isParenthesesValid.php)| 【反省回】時間をかけすぎた回 |
| 06-28 | スタック | stockSpan | JavaScript | [Code](../Stack/stockSpan/js/src/stockSpan.js)| スタックを配列で実装 |
| 06-29 | デック | minWindowArrK | PHP | [Code](../Deque/problems/04_minWindowArrK/php/src/minWindowArrK.php)| スライディングウィンドウの考え方を復習 |
| 06-30 | 二分木 | BinaryTreeクラス | JavaScript / PHP | [Code](../binary-tree/src/js/BinaryTree.js)| スタックを配列で実装 |